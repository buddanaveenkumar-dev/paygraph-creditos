  ...
  return <main className="deel-page">
    ...
    <section className="deel-console">
      ...
      <div className="console-grid">
        ...
        <div className="api-contract"><p className="panel-kicker">Pinned API contract</p><div><span>Environment</span><code>api-sandbox.demo.deel.com/rest</code></div><div><span>Version</span><code>2026-01-01</code></div><div><span>Read model</span><code>GET /contracts</code><code>GET /payments</code></div><div><span>Events</span><code>payment.completed</code><code>contract.status.updated</code></div><div><span>Verification</span><code>X-Deel-Signature</code><code>HMAC-SHA256</code></div></div>
      </div>
    </section>
