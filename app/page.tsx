  ...
  return (
    <main>
      ...
      <section className="founder-section" id="founder">
        <div><p className="eyebrow"><BadgeCheck size={14} /> Operator evidence</p><blockquote>“Transforming real-time workforce telemetry into governed, institutional-grade credit infrastructure.”</blockquote></div>
